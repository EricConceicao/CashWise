                    ...
                    <Row>
                        <Col md={12} className="mb-4">
                            <Card>
                                ...
                                <Card.Body>
                                <Card.Img src="img/investtodos.png" alt="Imagem do artigo poupança" />
                                    ...
                                    <Card.Text>
                                        ...
                                        <p>É importante entender que tanto a renda ativa quanto a renda passiva podem ser parte de uma estratégia financeira saudável. Muitas pessoas buscam diversificar suas fontes de renda, combinando trabalho ativo com investimentos que geram renda passiva.
                                        </p>
