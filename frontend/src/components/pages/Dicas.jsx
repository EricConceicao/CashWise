                ...
                <div className="container p-5 bg-light text-justfy">
                    ...
                    <Row className="align-items-left p-2"><h2 className='fw-bold text-center p-4'>Veja como organizar suas finanças:</h2>
                        <Col md={12} className="mb-4">
                            <Card>
                                <Card.Body>
                                    <Card.Img id='card-img' src="img/dicasorg.png" alt="Imagem do artigo dicas" style={{ width: '95%', height: 'auto', float: 'left', marginRight: '10px ' }} />
                                    <Card.Text style={{ textAlign: "justify" }}>A economia financeira refere-se à gestão eficiente dos recursos monetários disponíveis, sendo um conjunto de práticas e estratégias que visa promover a estabilidade econômica pessoal, garantindo o equilíbrio entre o presente e o futuro financeiro.</Card.Text>
                                </Card.Body>
                            </Card>
                        </Col>
                        ...
                        <Col lg={6} md={6} className="mb-4">
                            <Card>
                                <Card.Body>                                   
                                    ...
                                    <Card.Text>
                                        <ul> < Dica size={150} className='fs-4' />
