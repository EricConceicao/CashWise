                            ...
                            <Card border="#213740" style={{ borderWidth: '3px' }}>
                                <Card.Body>
                                    ...
                                    <Card.Text style={{ textAlign: "justify" }}>
                                        ...
                                        <p> Nesse módulo queremos dar ênfase em uma parte muito importante da renda passiva que é a Previdência Social. A Previdência Social é um seguro público que
                                        ...
                                        <p> Todos os trabalhadores, sejam da iniciativa privada, seja do serviço público ou mesmo empresários, são automaticamente filiados a um Regime Previdenciário,
                                        ...
                                        <p> A partir da Emenda Constitucional 103/2019 (
                                            ...
                                            ), que entrou em vigor em 13 de novembro de 2019, <strong>o cálculo dos benefícios de Auxílio Doença e aposentadoria</strong> para os trabalhadores que ingressaram no sistema previdenciário após a vigência da reforma <strong>mudou</strong> em relação ao modelo anterior.</p>
