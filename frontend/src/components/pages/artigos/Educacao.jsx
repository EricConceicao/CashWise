                            ...
                            <Card border="#213740" style={card} >
                                <Card.Body>
                                    ...
                                    <Card.Text style={{ textAlign: "justify" }}>
                                        <p>A educação financeira engloba o <CoinText textId="edu-1">conjunto de conhecimentos</CoinText> e habilidades fundamentais para administrar as finanças 
                                        de forma abrangente. Vai muito além do simples <CoinText textId="edu-2">controle dos gastos</CoinText> diários, envolvendo também a capacidade de 
                                        ...
                                        conscientes e equilibradas em relação ao dinheiro, o que é essencial para alcançar <CoinText textId="edu-3">metas financeiras</CoinText> e manter uma 
                            ...
                            <Card border="#213740" style={card}>
                                <Card.Body>
                                    ...
                                    <Card.Text style={{ textAlign: "justify" }}>
                                        ...
                                        financeira atua como um catalisador, <CoinText textId="edu-4">capacitando as pessoas</CoinText> a tomarem decisões mais informadas e conscientes 
                                        não apenas em questões monetárias, mas também em outras esferas da vida. Ao promover a autonomia e a habilidade de 
                                        planejar de forma estratégica, ela contribui para a <CoinText textId="edu-5">estabilidade econômica</CoinText> geral, impulsionando o crescimento sustentável 
                                ...
                                <Card.Body>
                                    ...
                                    <Card.Text style={{ textAlign: "justify" }}>
                                        <ul className='list-unstyled'>
                                            <li><Money size={22} className='text-primary' /> Reduzir o <CoinText textId="edu-6">Estresse Financeiro</CoinText> através do conhecimento adequado se reduz a ansiedade associada a questões monetárias, permitindo lidar melhor com imprevistos e crises econômicas pessoais;</li>
                                            <li><Money size={22} className='text-primary' /> Estimular o Empreendedorismo que capacita indivíduos a identificar oportunidades de negócio, entender os riscos financeiros e tomar decisões mais sólidas ao iniciar <CoinText textId="edu-7">empreendimentos próprios</CoinText>;</li>
                                            <li><Money size={22} className='text-primary' /> Evitar o superendividamento precoce;</li>
                                            <li><Money size={22} className='text-primary' /> Favorecer a Saúde Mental, pois com uma base financeira sólida, as pessoas conseguem focar mais na <CoinText textId="edu-8">qualidade de vida</CoinText>, reduzindo problemas relacionados à saúde mental causados por problemas financeiros;</li>
                                            <li><Money size={22} className='text-primary' /> Promover a Independência Financeira, capacitando indivíduos a serem <CoinText textId="edu-9">independentes financeiramente</CoinText>, não dependendo apenas de fontes externas de renda, o que proporciona <CoinText textId="edu-10">liberdade e autonomia</CoinText>;</li>
                                            ...
                                            <li><Money size={22} className='text-primary' /> Aumentar a Eficiência no Uso de Recursos, pois ensina a otimizar recursos disponíveis, evitando desperdícios e contribuindo para uma <CoinText textId="edu-11">economia mais sustentável</CoinText>;</li>
