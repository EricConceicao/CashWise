                    ...
                    <Row className='px-2 py-3'>
                        ...
                        <Col md={12} className="mb-4">
                            <section>
                                <Card style={card}>
                                    <Card.Body>
                                        <Card.Title className='fs-5 p-3 bg-info rounded-3' style={{ textAlign: "center" }}>Qual é a Diferença entre Renda Ativa e Renda Passiva?</Card.Title>                                                                        <Card.Title></Card.Title>
